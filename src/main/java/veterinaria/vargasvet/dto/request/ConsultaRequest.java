...
import veterinaria.vargasvet.validation.StrictIntegerDeserializer;
...
public class ConsultaRequest {
    ...
    @Digits(integer = 3, fraction = 2, message = "El peso admite como máximo dos decimales")
    ...
    @Digits(integer = 2, fraction = 1, message = "La temperatura admite como máximo un decimal")
    ...
    @NotNull(message = "La decisión de vacunación es obligatoria")
    private Boolean vacunacionAplicada;
    private String observacionVacunacion;
    @NotNull(message = "La decisión de desparasitación es obligatoria")
