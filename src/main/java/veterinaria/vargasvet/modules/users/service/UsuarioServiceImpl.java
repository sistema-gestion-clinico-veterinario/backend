...
import veterinaria.vargasvet.modules.users.security.TokenProvider;
...
public class UsuarioServiceImpl implements UsuarioService {
    ...
    @Override
    @Transactional
    public void changePassword(String email, veterinaria.vargasvet.modules.users.dto.request.ChangePasswordDTO dto) {
        Usuario usuario = usuarioRepository.findByEmail(email)
                .orElseThrow(() -> new ResourceNotFoundException("Usuario no encontrado"));
    ...
    @Override
    @Transactional
    public void resetPassword(veterinaria.vargasvet.modules.users.dto.request.AdminChangePasswordRequest dto) {
