package veterinaria.vargasvet.modules.users.domain.entity;
...
public class Empleado {
    ...
    private Set<veterinaria.vargasvet.modules.inventory.domain.entity.EmpleadoServicio> servicios = new HashSet<>();
