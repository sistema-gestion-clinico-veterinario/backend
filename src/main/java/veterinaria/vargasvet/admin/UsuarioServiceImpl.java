...
import veterinaria.vargasvet.shared.TokenProvider;
...
import veterinaria.vargasvet.admin.MenuService;
import veterinaria.vargasvet.admin.MenuDTO;
import veterinaria.vargasvet.shared.SecurityUtils;

@Service
@RequiredArgsConstructor
public class UsuarioServiceImpl implements veterinaria.vargasvet.admin.UsuarioService {
    ...
    @Override
    @Transactional
    public void changePassword(String email, veterinaria.vargasvet.auth.ChangePasswordDTO dto) {
        Usuario usuario = usuarioRepository.findByEmail(email)
                .orElseThrow(() -> new ResourceNotFoundException("Usuario no encontrado"));
    ...
    @Override
    @Transactional
    public void resetPassword(veterinaria.vargasvet.auth.AdminChangePasswordRequest dto) {
