...
public class MenuBuilderService {
    ...
    static {
        ...
        LEER.put("VISTA_CARTILLA",      new String[]{"CLINICAL_RECORD_READ", "PET_HISTORY_READ"});
        ESCRIBIR.put("VISTA_CARTILLA",  new String[]{"CLINICAL_RECORD_MANAGE", "PET_HISTORY_WRITE"});
        MODIFICAR.put("VISTA_CARTILLA", new String[]{"CLINICAL_RECORD_MANAGE", "PET_HISTORY_WRITE"});
        ELIMINAR.put("VISTA_CARTILLA",  new String[]{"CLINICAL_RECORD_MANAGE", "PET_HISTORY_WRITE"});
